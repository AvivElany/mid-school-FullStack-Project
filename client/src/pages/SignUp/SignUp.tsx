...
export default function SignUp() {
  ...
  const [classroom, setClassroom] = useState<string>('ז-1');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const userData = {
      ...
      password: password,
      image: {
        url: 'https://i.pinimg.com/736x/d2/86/11/d2861141a4a75eb863d91518da04b13f.jpg',
        alt: firstName,
      },
      address: {
        country: country,
        ...
        <Row>
          ...
          <Col xs="auto" className='border border-1 rounded-3 border-secondary-subtle p-5 text-start'>
            <Form onSubmit={handleSubmit}>
              ...
              <Row className="mt-1">
                <Form.Select aria-label="Default select example" value={classroom} onChange={(e)=>setClassroom(e.target.value)}>
              ...
              <Row className="mt-4 fw-bold">
                <Form.Label>האם הנרשם מורה?</Form.Label>
              </Row>
              ...
              <Row className="mt-4 fw-bold">
                <Form.Label>האם הנרשם זכר?</Form.Label>
              </Row>
